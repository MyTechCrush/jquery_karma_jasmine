...
app.Grid = (function() {
    ...
    Grid.prototype.init = function() {
        var grid = this;
        this.model.fetch(this._getId()).then(function(response) {
            return grid.setData({
                data: response
            });
        }).fail(function() {
    ...
    Grid.prototype.setData = function(data) {
        var self = this;
        return this.utils.tmpl.loadTemplate('app/templates/grid.html').then(function(tplElem) {
...
app.GridData = (function() {
    ...
    GridData.prototype.fetch = function(docId) {
        ...
        return $.getJSON(this._getUrl(docId)).then(function(response) {
            return response[0];
        });
    };
